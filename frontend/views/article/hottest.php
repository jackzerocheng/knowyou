                ...
                if (!empty($article_list)) {
                            ...
                            <div class="row align-items-center">
                                <div class="col-12 col-md-6">
                                    <div class="single-blog-thumbnail">
                                        <a href="<?=Url::to(['article/index', 'id' => $_article['id']]) ?>"><?=Html::img($_article['cover']) ?></a>
                                        <div class="post-date">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="single-blog-content">
                                        ...
                                        <p><a href="<?=Url::to(['article/index', 'id' => $_article['id']]) ?>"><?=substr($_article['content'], 0, 20) . '...' ?></a></p>
                                        <div class="post-meta">
                                            <p>By <a href="#"><?=$_article['username'] ?></a></p>
                                            <p><?=$_article['redis_read_number'] ?? $_article['read_number'] ?>人已读</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="single-blog-area blog-style-2 mb-50 wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="1000ms">
                        <div class="row align-items-center">
                            <div class="col-12 col-md-6">
                                <div class="single-blog-thumbnail">
                                    <?=Html::img('http://data.jianmo.top/img/emoji/rotate_up.gif') ?>
                                    <?=Html::img('http://data.jianmo.top/img/emoji/rotate_down.gif') ?>
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <!-- Blog Content -->
