...
<form class="layui-form" method="post" action="<?=Url::to(['banner/update']) ?>">
    <input type="hidden" name="id" value="<?=$data['id'] ?>">
    <div class="layui-form-item">
        <label class="layui-form-label">名称</label>
        <div class="layui-input-block">
            <input type="text" name="name" class="layui-input" lay-verify="required" value="<?=$data['name']?:''  ?>" placeholder="请输入名称">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">图片链接</label>
        <div class="layui-input-block">
            <input type="text" name="img" class="layui-input" lay-verify="" value="<?=$data['img']?:'' ?>" placeholder="非必填">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">跳转地址</label>
        <div class="layui-input-block">
            <input type="text" name="link" class="layui-input" lay-verify="" value="<?=$data['link']?:'' ?>" placeholder="非必填">
        </div>
    </div>
    <div class="layui-form-item">
